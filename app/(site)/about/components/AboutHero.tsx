...
export const AboutHero = () => {
  const imageStyles =
    "animate-float border-greyscale-100 col-span-2 col-start-2 dark:border-greyscale-900 border shadow-md transition-[scale] duration-500 hover:scale-105 aspect-square rounded-xl overflow-hidden ";
