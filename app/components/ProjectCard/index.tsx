...
export const ProjectCard = ({ project }: ProjectCardPropTypes) => {
  return (
    <article
      className={`bg-greyscale-50 dark:bg-greyscale-950 shadow-card-light group border-greyscale-950/10 col-span-full flex flex-col gap-2 rounded-xl border-[1px] p-2 !transition-all hover:scale-[99%] md:flex-row dark:!shadow-[var(--card-dark)] ${
        ...
        <div className="flex w-full flex-col justify-between gap-4">
          ...
          <div className="flex flex-row items-end justify-between gap-2">
            ...
            <IconButton
              ...
              icon={
                <span
                  className={`dark:text-greyscale-50 !transition-all duration-300 group-hover:-rotate-45 hover:bg-transparent ${project.DISCIPLINE === "design" ? "group-hover:border-sky-600 group-hover:text-sky-600" : "group-hover:text-grass-600 group-hover:border-grass-600"}`}
                >
                  <ArrowIcon />
                </span>
              }
