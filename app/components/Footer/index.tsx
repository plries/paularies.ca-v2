...
export const Footer = () => {
  return (
    <motion.footer
      ...
      className="border-greyscale-950/10 bg-greyscale-100 dark:border-greyscale-50/10 dark:bg-greyscale-900 dark:text-greyscale-100 x-3 col-span-full my-16 grid w-full max-w-7xl grid-cols-4 gap-x-3 gap-y-6 rounded-t-4xl rounded-b-none border-t-[1px] p-4 md:grid-cols-8 md:gap-x-4 md:p-6 md:pt-24 lg:w-[calc(100%-2rem)] lg:grid-cols-12 lg:rounded-b-4xl lg:border lg:p-8"
    >
