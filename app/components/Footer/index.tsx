...
import { IconContext, Moon, Sun } from "@phosphor-icons/react";
  ...
  return (
    <IconContext.Provider value={{ size: 20 }}>
      <motion.footer
        ...
        className="radial-gradient border-greyscale-200 bg-greyscale-100 dark:border-greyscale-700 dark:bg-greyscale-900 dark:text-greyscale-100 x-3 col-span-full my-16 grid w-[calc(100%-1.5rem)] max-w-[1440px] grid-cols-4 gap-x-3 gap-y-6 rounded-3xl border p-4 md:grid-cols-8 md:gap-x-4 md:p-6 md:pt-24 lg:w-[calc(100%-2rem)] lg:grid-cols-12 lg:rounded-4xl lg:border lg:p-8"
      >
