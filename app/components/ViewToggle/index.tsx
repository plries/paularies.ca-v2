...
export const ViewToggle = ({ isCode, toggleView }: ViewTogglePropTypes) => {
  return (
    <div className="bg-greyscale-100 dark:bg-greyscale-950 border-greyscale-950/10 dark:border-greyscale-50/10 relative right-0 flex w-full flex-row gap-1 rounded-lg border-[1px] p-1 shadow-[var(--button-light)] dark:shadow-[var(--button-dark)]">
      <div
