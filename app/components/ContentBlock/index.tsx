...
export const ContentBlock = ({
  ...
  return (
    <motion.div
      ...
      className={`bg-greyscale-50 border-greyscale-950/10 dark:bg-greyscale-950 dark:border-greyscale-50/10 flex flex-col gap-3 rounded-xl border p-3 shadow-xs md:p-6 lg:p-8 ${additionalClasses ?? ""}`}
    >
      {children}
    </motion.div>
  );
