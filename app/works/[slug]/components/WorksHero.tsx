  ...
  return (
    <>
      <InsetBlock additionalClasses="!p-3 md:!p-6">
        <div className="bg-greyscale-50 border-greyscale-950/10 dark:border-greyscale-50/10 dark:bg-greyscale-950 col-span-full aspect-video rounded-lg border md:col-span-4 md:col-start-1 lg:col-span-6 lg:col-start-1">
          <Image
